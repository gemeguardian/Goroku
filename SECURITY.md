...
- **Not yet automated:** host GitHub secret-scanning org policy, PR dependency-review, license policy. Cosign is optional local (`COSIGN_YES=1` / `docs/RELEASE.md`), not a CI hard gate.
